...
export default function SignupPage() {
  return (
    <main className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md lg:max-w-lg">
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="mt-3 text-base text-slate-500 font-medium">
              Join us in just a minute and upgrade your security.
            </p>
          </div>
          ...
          <form className="space-y-5" action="#" method="POST" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="pt-2 flex items-start ml-1">
              <label className="relative flex cursor-pointer items-start gap-3 text-sm font-medium text-slate-600 leading-snug">
                <input
                  id="terms"
                  name="terms"
                  type="checkbox"
                ...
                />
                <div className="mt-0.5 h-5 w-5 shrink-0 rounded border border-slate-300 bg-white shadow-sm transition-all peer-checked:border-[#0f7af7] peer-checked:bg-[#0f7af7] peer-focus-visible:ring-2 peer-focus-visible:ring-[#0f7af7] flex items-center justify-center">
                ...
                <span>
                  I agree to the{" "}
                  <Link href="/signup" className="text-[#0f7af7] font-bold hover:underline underline-offset-2">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link href="/signup" className="text-[#0f7af7] font-bold hover:underline underline-offset-2">
          ...
          <p className="mt-8 text-center text-sm font-medium text-slate-600">
            ...
            <Link href="/login" className="text-[#0f7af7] hover:text-[#085fc3] font-bold underline decoration-2 underline-offset-4 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-[#0a2342] p-12 xl:p-24 text-white overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#0b4e9c] via-[#0f7af7] to-[#27a2ff] opacity-90 z-0"></div>
        
        {/* Decorative Orbs */}
        <div className="absolute -top-24 -right-24 w-96 h-96 rounded-full bg-white/10 blur-3xl z-0"></div>
        <div className="absolute bottom-10 -left-10 w-72 h-72 rounded-full bg-cyan-300/20 blur-2xl z-0"></div>
        ...
        <div className="relative z-10 w-full">
          <div className="inline-flex flex-row items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-semibold tracking-wide text-white backdrop-blur-md shadow-sm">
            ...
            <span>AccessNest New Account</span>
          </div>
          
          <h1 className="mt-12 text-5xl/tight font-extrabold tracking-tight">
            Create your account and start managing access <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-200 to-white">faster</span>.
          </h1>
          <p className="mt-6 max-w-lg text-lg text-blue-100/90 leading-relaxed font-normal">
            Add your team, automate approvals, and keep every entry tracked in one secure workspace.
          </p>
        </div>
        ...
        <div className="relative z-10 space-y-5">
          <div className="flex items-center gap-4 rounded-2xl bg-white/5 border border-white/10 p-5 backdrop-blur-sm transition-transform hover:-translate-y-1 hover:bg-white/10 w-max pr-12">
            ...
            <div>
              <h3 className="font-semibold text-base">Role-Based Controls</h3>
              <p className="text-sm text-blue-200 mt-1">Manage permissions across your entire team.</p>
            </div>
          </div>
          <div className="flex items-center gap-4 rounded-2xl bg-white/5 border border-white/10 p-5 backdrop-blur-sm transition-transform hover:-translate-y-1 hover:bg-white/10 w-max pr-12">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white/20">
            ...
            <div>
              <h3 className="font-semibold text-base">Built-In Transparency</h3>
              <p className="text-sm text-blue-200 mt-1">Automated logs and fully transparent operations.</p>
            </div>
          </div>
        </div>
      </div>
